...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="border-b border-border bg-background pt-28 sm:pt-32">
      <Container size="full" className="pb-10 sm:pb-12">
        ...
        <div className="grid gap-12 py-16 sm:py-24 lg:grid-cols-12 lg:gap-8 lg:py-28">
          <div className="lg:col-span-8">
            ...
            <h1 className="mt-8 max-w-5xl text-[clamp(4rem,11vw,9rem)] font-bold leading-[0.82] tracking-[-0.085em] text-foreground">
              Clayde<br />
              <span className="text-accent">Arnaiz</span>
            </h1>
          </div>

          <aside className="self-end border-l border-accent pl-5 lg:col-span-3 lg:col-start-10 lg:pb-2">
            <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-accent">Current work</p>
        ...
        <div className="grid gap-8 border-t border-border pt-6 sm:grid-cols-[auto_1fr_auto] sm:items-center">
          <div className="flex flex-wrap gap-3">
            <Button type="button" variant="primary" size="md" onClick={scrollToProjects} rightIcon={<ArrowDownRight className="h-4 w-4" />}>
              View featured work
            </Button>
            <Button href="/resume.pdf" target="_blank" variant="outline" size="md" rightIcon={<ArrowUpRight className="h-4 w-4" />}>
              Download résumé
            </Button>
          </div>
          <p className="hidden max-w-xs text-sm leading-relaxed text-muted-foreground sm:block">
            I am looking for software engineering and cloud engineering opportunities where systems thinking matters.
          </p>
